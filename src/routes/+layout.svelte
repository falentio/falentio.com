...
>
	<Navbar />
	<div class="flex flex-col flex-auto w-full md:min-h-screen container mx-auto">
		<main class="flex-auto px-4 py-2 shadow-xl ring-1 ring-black dark:ring-zinc-700">
			<slot />
		</main>
		<Footer />
	</div>
